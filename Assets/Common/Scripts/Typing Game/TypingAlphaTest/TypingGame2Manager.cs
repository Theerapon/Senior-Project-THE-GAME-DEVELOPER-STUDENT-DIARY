...
public class TypingGame2Manager : Manager<TypingGame2Manager>
{
    #region Events
    public Events.EventOnCheckedWordUpdate OnCheckedWordUpdate;
    public Events.EventOnTypingGameStateChanged OnTypingGameStateChanged;
    #endregion
    ...
    [SerializeField] private TypingGame2Spawner wordSpawner;
    [SerializeField] private TypingGame2MonsterSpawner wordMonsterSpawner;

    private TypingGame2Timer wordTypingAlphaTimer;
    ...
    private void Start()
    {
        wordTypingAlphaTimer = FindObjectOfType<TypingGame2Timer>();
    ...
    {
        baseWordTypingGame2Normal word = new baseWordTypingGame2Normal(WordGenerater.GetRandomWord(), wordSpawner);
    ...
    {
        baseWordTypingGame2Monster word = new baseWordTypingGame2Monster(WordGenerater.GetRandomWord(), wordMonsterSpawner, currentPosition, normalizeDirection, isRight);
        mainWordlist.Add(word.GetHashCode().ToString(), word);
        word.SetID(word.GetHashCode().ToString());
    }
    ...
    public void OutOffScreen(TypingGame2Box typingGame2Box)
    {
    ...
    public void MonsterOutOffScreen(TypingGame2MonsterBox typingGame2MonsterBox)
    {
